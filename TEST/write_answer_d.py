...
parser.add_argument('--answer', type=str, default='answer_d', metavar='A',
...
SaveFolderKey = {
    'coat_length_labels':'inceptionresnetv2_d',
    'collar_design_labels':'inceptionresnetv2_d',
    'lapel_design_labels':'inceptionresnetv2_d',
    'neck_design_labels':'inceptionresnetv2_d',
    'neckline_design_labels':'inceptionresnetv2_d',
    'pant_length_labels':'inceptionresnetv2_d',
    'skirt_length_labels':'resnet18_d',
    'sleeve_length_labels':'inceptionresnetv2_d',
}
