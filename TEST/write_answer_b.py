...
parser.add_argument('--answer', type=str, default='answer_b', metavar='A',
...
SaveFolderKey = {
    'coat_length_labels':'inceptionresnetv2_b',
    'collar_design_labels':'inceptionresnetv2_b',
    'lapel_design_labels':'inceptionresnetv2_b',
    'neck_design_labels':'inceptionresnetv2_b',
    'neckline_design_labels':'inceptionresnetv2_b',
    'pant_length_labels':'inceptionresnetv2_b',
    'skirt_length_labels':'resnet18_b',
    'sleeve_length_labels':'inceptionresnetv2_b',
}
